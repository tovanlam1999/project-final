...
export default function ServicesBody() {
    ...
    return (
        <div className="ServicesBody">
            ...
            <div className="ServicesBody_bottom">
                <Container>
                    <Row>
                        {images.map((item, index) => (
                            <Col key={index} md="6" className="ServicesBody_bottom-col">
                                <div className="ServicesBody_bottom-item">
                                    <div className="ServicesBody_bottom-item-thumb">
                                        <div className="ServicesBody_bottom-img">
                                            <img src={item.img} />
                                        </div>
                                        <div className="ServicesBody_bottom-subimg">
                                            <button>Đọc Thêm</button>
                                        </div>
                                    </div>
                                    <div className="ServicesBody_bottom-desc">
                                        <h3>{item.name}</h3>
                                        <p>{item.desc}</p>
                                    </div>
                                </div>
